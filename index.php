    ...
    <section class="section video-help-section">
        ...
        <div class="video-container-framed">
            <div class="video-wrapper">
                <video muted preload="none" id="coursePreviewVideo" playsinline webkit-playsinline controls poster="https://pub-548474bf1ef14b739e232f68668f1f91.r2.dev/images/Business%20masterclass%20at%20199%20rupees.png"></video>
            </div>
    ...
    <section class="section audience-section">
        ...
        <div class="audience-carousel-wrapper">
            ...
            <div class="audience-grid" id="audienceCarousel">
                ...
                <div class="audience-card">
                    <img src="https://pub-548474bf1ef14b739e232f68668f1f91.r2.dev/images/Business%20success%20course.png" alt="Students">
                    <div class="audience-info">
                        <h4> STUDENT</h4>
...
<!-- ===== END HERO BANNER SECTION ===== -->
    ...
    <section class="section faq-section" id="faq">
        ...
        <div class="faq-image">
            <img src="https://pub-548474bf1ef14b739e232f68668f1f91.r2.dev/images/MBA%20for%20startup%20course%20India.png" alt="Masterclass FAQ">
        </div>
    </section>
